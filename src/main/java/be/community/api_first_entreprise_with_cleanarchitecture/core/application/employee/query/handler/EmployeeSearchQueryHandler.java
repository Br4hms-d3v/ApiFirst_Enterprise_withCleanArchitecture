...
public class EmployeeSearchQueryHandler
    implements QueryHandler<EmployeeSearchQuery, List<EmployeeDto>, EmployeeError> {

  private final EmployeeRepository employeeRepository;
  private final EmployeeMapper employeeMapper;

  public EmployeeSearchQueryHandler(
  ...
  public Result<EmployeeError, List<EmployeeDto>> handle(EmployeeSearchQuery query) {
    ...
    List<EmployeeDto> result = employeesByName.stream().map(employeeMapper::toDto).toList();
